...
namespace DbConnect.Business.MSSQL
{
    ...
    {
        public double? basabas_noktasi { get; set;}
        public double? capak_alma_kat_sayi { get; set;}
        public double? diger_sarf_maliyet { get; set;}
        public string firma_adi { get; set;}
        public double? fiyat { get; set;}
        public double? gunde_uretilecek_adet { get; set;}
        public int id { get; set;}
        public double? iscilik_maliyeti { get; set;}
        public double? kar { get; set;}
        public double? kar_orani { get; set;}
        public double? karisim_gaz_maliyet { get; set;}
        public double? kayip_zaman_kat_sayi { get; set;}
        public double? kaynak_tel_maliyet { get; set;}
        public string kaynak_tipi { get; set;}
        public double? kaynak_uzunluk { get; set;}
        public double? matrah { get; set;}
        public string padi { get; set;}
        public double? parca_maliyeti { get; set;}
        public int pkod { get; set;}
        public double? sabit_maliyeti { get; set;}
        public double? toplam_maliyet { get; set;}
        public double? uretim_suresi { get; set;}
    ...
    public class urun_agaci
    {
        public int? id { get; set;}
        public string p_adi { get; set;}
        public decimal? p_fiyat { get; set;}
        public string p_kod1 { get; set;}
        public string p_kod2 { get; set;}
    }
    public class urun
    {
    ...
    public class hmadde_duz
    {
        ...
        public decimal? q1fiyat { get; set;}
        public decimal? q2fiyat { get; set;}
        public decimal? q3fiyat { get; set;}
        public decimal? q4fiyat { get; set;}
    }
    public class mamul
    {
        public int? hmkod { get; set;}
